"""
TechCrunch.com specific scraper implementation.
"""
import re
...
class TechCrunchScraper(BaseScraper):
    ...
    def scrape_article(self, url: str) -> Optional[Dict]:
        ...
        try:
            ...
            # Extract subtitle/deck (TechCrunch doesn't have subtitles usually)
            if self.config.article_selectors['subtitle']:
    ...
    def extract_tags(self, soup: BeautifulSoup) -> List[str]:
        ...
        # Try different tag selectors for TechCrunch
        tag_selectors = [
            '.tags a',
            '.entry-categories a',
            '.post-categories a',
